...
const Instructor = () => {
    ...
    useEffect(() => {
        ;(async() => {
            setLoading(true);
            const instructorData = await getInstructorCourseDetails(token);
            ...
            </div>
            {
                loading ? (
                    ...
                    <div className='flex flex-col gap-5'>
                        <div className='flex gap-4 h-[450px] w-full'>
                            ...
                            <div className="flex min-w-[250px] flex-col rounded-md bg-richblack-800 p-6 mt-8 h-full">
                                        ...
                                        <div className="mt-3 w-full">
                                            ...
                                            <div className="mt-1 flex items-center space-x-2">
                                                <p className="text-xs font-medium text-richblack-300">
                                                    {course.studentsEnrolled.length} Buyers
                                                </p>
                                                <p className="text-xs font-medium text-richblack-300">
                                                    |
                                                </p>
